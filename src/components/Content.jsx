  ...
  const conceptCars = [
    {
      ...
      images: [
        `${process.env.PUBLIC_URL}/assets/mercedesvision.jpeg`,
        `${process.env.PUBLIC_URL}/assets/m2.jpeg`,
      ],
      year: 2020,
    ...
    },
    {
      ...
      images: [
        `${process.env.PUBLIC_URL}/assets/rollsroycenext100.jpg`,
        `${process.env.PUBLIC_URL}/assets/roll2.jpg`,
      ],
      year: 2016,
    ...
    },
    {
      ...
      images: [
        `${process.env.PUBLIC_URL}/assets/hyundaielevate.jpg`,
        `${process.env.PUBLIC_URL}/assets/elevate1.jpg`,
      ],
      year: 2019,
    ...
    },
    {
      ...
      images: [
        `${process.env.PUBLIC_URL}/assets/toyotafunvii.jpg`,
        `${process.env.PUBLIC_URL}/assets/fun2.jpg`,
      ],
      year: 2011,
    ...
    },
    {
      ...
      images: [
        `${process.env.PUBLIC_URL}/assets/aeromobil.jpg`,
        `${process.env.PUBLIC_URL}/assets/aero.jpg`,
      ],
      year: 2017,
